...
if(rem(t,Ts)>=0&&rem(t,Ts)<Ts*dc/4)
    h=[Vd1 Ia1 1 rem(t,Ts) sector];
elseif(rem(t,Ts)>=Ts*dc/4&&rem(t,Ts)<Ts*(dc/4+1/2*da*Da1))
    h=[Va1 Ia1 2 rem(t,Ts) sector];
elseif(rem(t,Ts)>=Ts*(dc/4+1/2*da*Da1)&&rem(t,Ts)<Ts*(dc/4+1/2*da*Da1+da*Db1))    
    h=[Va1 Ib1 3 rem(t,Ts) sector];
elseif(rem(t,Ts)>=Ts*(dc/4+1/2*da*Da1+da*Db1)&&rem(t,Ts)<Ts*(dc/4+1/2*da*Da1+da*Db1+1/2*da*Da1))  
    h=[Va1 Ia1 4 rem(t,Ts) sector];
elseif(rem(t,Ts)>=Ts*(dc/4+1/2*da*Da1+da*Db1+1/2*da*Da1)&&rem(t,Ts)<Ts*(dc/4+1/2*da*Da1+da*Db1+1/2*da*Da1+1/2*dc))  
    h=[Vd1 Ia1 5 rem(t,Ts) sector];
elseif(rem(t,Ts)>=Ts*(dc/4+1/2*da*Da1+da*Db1+1/2*da*Da1+1/2*dc)&&rem(t,Ts)<Ts*(dc/4+1/2*da*Da1+da*Db1+1/2*da*Da1+1/2*dc+1/2*db*Da1))  
    h=[Vb1 Ia1 6 rem(t,Ts) sector]; 
elseif(rem(t,Ts)>=Ts*(dc/4+1/2*da*Da1+da*Db1+1/2*da*Da1+1/2*dc+1/2*db*Da1)&&rem(t,Ts)<Ts*(dc/4+1/2*da*Da1+da*Db1+1/2*da*Da1+1/2*dc+1/2*db1*Da1+db*Db1))  
    h=[Vb1 Ib1 7 rem(t,Ts) sector];
elseif(rem(t,Ts)>=Ts*(dc/4+1/2*da*Da1+da*Db1+1/2*da*Da1+1/2*dc+1/2*db*Da1+db*Db1)&&rem(t,Ts)<Ts*(dc/4+1/2*da*Da1+da*Db1+1/2*da*Da1+1/2*dc+1/2*db*Da1+db*Db1+1/2*db*Db1))  
    h=[Vb1 Ia1 8 rem(t,Ts) sector];  
 elseif(rem(t,Ts)>=Ts*(dc/4+1/2*da*Da1+da1*Db1+1/2*da*Da1+1/2*dc+1/2*db*Da1+db*Db1+1/2*db*Db1)&&rem(t,Ts)<Ts)  
    h=[Vd1 Ia1 9 rem(t,Ts) sector];
end
sys=h;
end
